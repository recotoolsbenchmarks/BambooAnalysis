...
cv.Divide(3)
cv.cd(1)
be.getPlotResults(myPlot)[0].Draw()
cv.cd(2)
be.getPlotResults(myOtherPlot)[0].Draw()
cv.cd(3)
be.getPlotResults(myMPlot)[0].Draw()
cv.Update()
cv.Draw()
...
cv2.Divide(3)
cv2.cd(1)
be.getPlotResults(myNsPlot)[0].Draw()
cv2.cd(2)
be.getPlotResults(leadMyMuPtPlot)[0].Draw()
cv2.cd(3)
be.getPlotResults(centralMuPtPlot)[0].Draw()
cv2.Update()
cv2.Draw()
...
cv3.Divide(2)
cv3.cd(1)
be.getPlotResults(myMuSumEtaPlot)[0].Draw()
cv3.cd(2)
be.getPlotResults(mostCentralMuPt)[0].Draw()
cv3.Update()
cv3.Draw()
...
cv4.Divide(2)
cv4.cd(1)
be.getPlotResults(newMPlot)[0].Draw()
cv4.cd(2)
be.getPlotResults(nJets)[0].Draw()
cv4.Update()

cv5 = ROOT.TCanvas("c5")
cv5.Divide(2)
cv5.cd(1)
be.getPlotResults(nOSDimu)[0].Draw()
cv5.cd(2)
be.getPlotResults(nOSelmu)[0].Draw()
cv5.Update()

cv6 = ROOT.TCanvas("c6")
cv6.Divide(2)
cv6.cd(1)
be.getPlotResults(nTagEle)[0].Draw()
cv6.cd(1)
be.getPlotResults(tnpelemass)[0].Draw()
cv6.Update()
